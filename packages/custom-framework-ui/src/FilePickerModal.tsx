 ...
 * Copied styling from system framework's FilePickerModal
 */
...
// Copied from system framework FilePickerModal
    ...
    >
      <DialogTitle sx={{ pb: 1 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
          <Box>
            <Typography sx={{ fontSize: 18, fontWeight: 600, color: "#101828" }}>
              {title}
            </Typography>
            <Typography sx={{ fontSize: 14, color: "#475467", mt: 0.5 }}>
      ...
      <DialogContent>
        {/* Copied exact styling from system framework FilePickerModal */}
        <Stack spacing={2.5}>
          {/* Search with inline icon - exact copy */}
          <TextField
            fullWidth
            size="small"
          ...
          {/* Header row with select all and count - exact copy */}
